              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    disabled={!selectedScan || generatingReport === `${selectedScan.id}-${report.type}`}
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              ...
              className="px-3 py-1 bg-gray-700/50 border border-gray-600 rounded-lg text-gray-300 hover:bg-gray-600/50 transition-colors text-sm"
            >
              Refresh
            </button>
          </div>
